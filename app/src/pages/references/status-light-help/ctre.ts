...
export const ctreHelp = {
	...
	"ctretalonfx.enabled-codes.talon-limited-offset-direction-forward-reverse": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still on the limit with nothing pressing the switch?",
				yes: "Replace the limit switch.",
				no: "Problem solved.",
			},
		],
		source: CTRE_FX,
	...
	"ctretalonsrx.calibration-codes.calibration-in-progress": {
		...
		steps: [
			{
				kind: "check",
				text: "Is this robot controlled over CAN?",
				yes: "Ignore it, PWM calibration does nothing.",
				no: "Continue.",
			},
			"Release the B/C CAL button.",
			{
				kind: "check",
				text: "Still flashing red and green?",
				yes: "Power cycle the controller.",
				no: "Problem solved.",
			},
		],
		source: CTRE_SRX,
	...
	"ctrevictorspx.normal-operation-codes.fault-detected": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still faulting with good power and no load?",
	...
	"ctrecanivore.stat.usb-plugged-in-but-no-comms": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Does Phoenix Tuner X see the CANivore now?",
				yes: "Problem solved.",
				no: "Swap the CANivore.",
			},
		],
		source: CTRE_CANIVORE,
	},
	...
	"ctrecanivore.can.voltage-too-low-for-can-bus": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Is the CAN LED still solid red?",
				yes: "Swap the CANivore.",
				no: "Problem solved.",
			},
		],
		source: CTRE_CANIVORE,
	...
	"ctrecancoder.bright-can-and-magnet-out-of-range": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still rapid bright red with a good magnet fitted?",
				yes: "Swap the CANcoder.",
				no: "Problem solved.",
			},
		],
		source: CTRE_CANCODER,
	...
	"ctretbcancoder.bright-can-and-magnet-out-of-range": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still rapid bright red with the ring seated right?",
				yes: "Swap the CANcoder.",
				no: "Problem solved.",
			},
		],
	...
	"ctrecandle.5v-too-high-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Does the 5 V fault stay with the strip unplugged?",
				yes: "Swap the CANdle.",
				no: "Problem solved.",
			},
		],
	...
	"ctrecandle.short-circuit-or-software-fuse-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Does the fault clear with the strip unplugged?",
				yes: "Replace the strip or its cable.",
				no: "Continue.",
			},
	...
	"ctrepowerdistributionpanel.no-power": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Is the LED still off with the battery connected right?",
				yes: "Swap the PDP.",
				no: "Problem solved.",
			},
		],
	...
	"ctrepowerdistributionpanel.disabled-sticky-fault-present": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Is the logged fault a brownout?",
	...
	"ctrepneumaticscontrolmodule.solenoid-status-led.solenoid-on": {
		...
		steps: [
			{
				kind: "check",
				text: "Does the cylinder stay put with this LED on?",
				yes: "Continue.",
				no: "Problem solved.",
			},
