...
export const revHelp = {
	"revsparkmax.brushless-mode.brake-no-signal": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still blinking cyan?",
				yes: "The controller is fine. Fix code or comms.",
				no: "Problem solved.",
			},
		],
		source: REV_MAX,
	...
	"revsparkmax.brushless-mode.brake-valid-signal": {
		...
		steps: [
			{
				kind: "check",
				text: "Does the motor move when commanded?",
				yes: "Normal. Zero output looks like this.",
				no: "Continue.",
			},
			...
			{
				kind: "check",
				text: "Is the encoder cable or connector damaged?",
	...
	"revsparkmax.brushed-mode.brake-no-signal": {
		...
		steps: [
			{
				kind: "check",
				text: "Is a brushless motor attached?",
				yes: "Stop. Set the type to brushless.",
				no: "Continue.",
			},
			{ kind: "check", text: "Is the robot enabled?", no: "Normal while disabled.", yes: "Continue." },
		...
		steps: [
			{
				kind: "check",
				text: "Is a brushless motor attached?",
				yes: "Do not enable. Set the type to brushless.",
				no: "Normal. Brushed brake, valid signal.",
			},
		],
		source: REV_MAX,
	},
		...
		steps: [
			{
				...
				text: "Is a brushless motor attached?",
				yes: "Do not enable. Set the type to brushless.",
				no: "Normal. Brushed coast, valid signal.",
			},
		],
		source: REV_MAX,
	},
	"revsparkmax.fault-conditions.sensor-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Is the sensor cable or connector damaged?",
				yes: "Replace the motor.",
				no: "Continue.",
			},
			...
			{
				kind: "check",
				text: "Still faulting with a known good motor?",
	...
	"revsparkmax.fault-conditions.12v-missing": {
		...
		steps: [
			{
				kind: "check",
				text: "Is the controller on the bench over USB only?",
				yes: "Expected. It needs 12 V to drive.",
				no: "Continue.",
			},
			...
			{
				kind: "check",
				text: "Still blinking orange and blue?",
				yes: "Trace the 12 V feed to this controller.",
				no: "Problem solved.",
			},
		],
		source: REV_MAX,
	...
	"revsparkmax.fault-conditions.can-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still blinking orange and yellow?",
				yes: "Swap the controller.",
				no: "Problem solved.",
			},
		],
	...
	"revsparkmax.identification-updating-and-recovery.can-firmware-updating-v1-5-0": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Stuck here for minutes?",
				yes: "Power cycle and update over USB.",
				no: "Problem solved.",
			},
		],
		source: REV_MAX,
	...
	"revsparkmax.identification-updating-and-recovery.can-firmware-retry": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still stuck here?",
				yes: "Update over USB in the REV Hardware Client.",
				no: "Problem solved.",
			},
		],
		source: REV_MAX,
	...
	"revsparkmax.movement.forward-limit": {
		...
		steps: [
			{
				kind: "check",
				text: "Is the mechanism sitting on the forward limit?",
				yes: "Move it off the limit.",
				no: "Continue.",
			},
			...
			{
				kind: "check",
				text: "Still blocked forward?",
				yes: "Fix the switch wiring or polarity.",
				no: "Problem solved.",
			},
		],
		source: REV_MAX,
	...
	"revsparkmax.movement.reverse-limit": {
		...
		steps: [
			{
				kind: "check",
				text: "Is the mechanism sitting on the reverse limit?",
				yes: "Move it off the limit.",
				no: "Continue.",
			},
			"Check the limit switch and its wiring at the data port. A disconnected normally closed switch reads as pressed.",
	...
	"revsparkflex.brushless-mode.brake-valid-signal": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still not moving?",
				yes: "Swap the Vortex or the controller.",
				no: "Problem solved.",
			},
		],
		source: REV_FLEX,
	...
	"revsparkflex.fault-modes.sensor-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Is the motor a Vortex or NEO with a bad sensor?",
				yes: "Replace the motor.",
				no: "Continue.",
			},
			{
				kind: "check",
				text: "Is a separate brushed encoder cable damaged?",
				yes: "Swap that cable.",
				no: "Continue.",
			},
	...
	"revsparkflex.fault-modes.temperature-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Does it overheat again after cooling?",
				yes: "Find the mechanical bind or high load.",
				no: "Problem solved.",
			},
		],
		source: REV_FLEX,
	...
	"revpowerdistributionhub.general-status.no-communication-established": {
		...
		steps: [
			...
			"Confirm robot code is running. The roboRIO Comm LED is green.",
			{
				kind: "check",
				text: "Still blue?",
				yes: "Trace CAN from the roboRIO to the PDH.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.general-status.keep-alive-timeout": {
		...
		steps: [
			...
			"Power cycle.",
			{
				kind: "check",
				text: "Still blinking magenta?",
				yes: "Fix the roboRIO comms or CAN wiring.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.general-status.low-battery": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still low after a good battery?",
				yes: "Fix the main leads or breaker.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.general-status.device-over-current": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still over current?",
				yes: "Find the short or stall on a channel.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.channel-status.no-voltage-and-active-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still no voltage?",
				yes: "Check the channel load for a short.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.channel-status.sticky-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Does the fault come back?",
				yes: "Find the intermittent short or tripping breaker.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.switched-channel.no-voltage-and-active-fault": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still no voltage on the switched channel?",
				yes: "Check the load for a short.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpowerdistributionhub.switched-channel.sticky-fault": {
		...
		steps: [
			...
			"Clear sticky faults from the REV Hardware Client or from code.",
			{
				kind: "check",
				text: "Does the fault come back?",
				yes: "Find the intermittent short on that channel.",
				no: "Problem solved.",
			},
		],
		source: REV_PDH,
	...
	"revpneumaticshub.general-status.no-communication-established": {
		...
		steps: [
			...
			"Confirm the code creates a pneumatics object for the REV hub type.",
			{
				kind: "check",
				text: "Still blue?",
				yes: "Trace CAN from the roboRIO to the hub.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
	...
	"revpneumaticshub.general-status.compressor-over-current": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Still over current on the compressor?",
				yes: "Replace the compressor or fix its wiring.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
	...
	"revpneumaticshub.general-status.device-over-current": {
		...
		steps: [
			...
			{
				kind: "check",
				text: "Did unplugging one clear it?",
				yes: "Fix or replace that solenoid.",
				no: "Continue.",
			},
			...
			"Power cycle.",
			{
				kind: "check",
				text: "Still over current?",
				yes: "Fix the shorted solenoid output.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
	...
	"revpneumaticshub.compressor-status.compressor-off": {
		...
		steps: [
			{
				kind: "check",
				text: "Should the compressor be running now?",
				yes: "Continue.",
				no: "Normal. It is at pressure or disabled.",
			},
			"Check the pressure switch wiring.",
			"Check the code enables the compressor.",
			{
				kind: "check",
				text: "Still off when it should run?",
				yes: "Fix the pressure switch or code.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
	...
	"revpneumaticshub.compressor-status.compressor-on": {
		...
		steps: [
			{
				kind: "check",
				text: "Is the compressor silent with this LED on?",
				yes: "Continue.",
				no: "Normal. The output is on.",
			},
	...
	"revpneumaticshub.solenoid-status.solenoid-off": {
		...
		steps: [
			{
				kind: "check",
				text: "Should this solenoid be on now?",
				yes: "Continue.",
				no: "Normal. It is commanded off.",
			},
			"Check the code commands this channel on.",
			"Confirm the channel number matches the wiring.",
			{
				kind: "check",
				text: "Still off when commanded on?",
				yes: "Fix the code or the channel number.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
	...
	"revpneumaticshub.solenoid-status.solenoid-on": {
		...
		steps: [
			{
				kind: "check",
				text: "Does the cylinder move with this LED on?",
				yes: "Normal. The output is energized.",
				no: "Continue.",
			},
			...
			"Check the solenoid voltage setting matches the solenoid.",
			{
				kind: "check",
				text: "Still not moving?",
				yes: "Replace the solenoid or cylinder.",
				no: "Problem solved.",
			},
		],
		source: REV_PH,
