		...
		<Accordion flush class="text-left">
					...
					<div class="flex flex-row items-center">
						<button
							onclick={(e) => {
								e.stopPropagation();
								enlarge(
									"/references/components/images/rev-pdh-large.webp",
									"REV Power Distribution Hub",
								);
							}}
							class="cursor-zoom-in rounded hover:ring-2 hover:ring-blue-400 transition"
					...
					<div class="flex flex-row items-center">
						<button
							onclick={(e) => {
								e.stopPropagation();
								enlarge(
									"/references/components/images/rev-pneumatic-hub-large.webp",
									"REV Pneumatic Hub",
								);
							}}
							class="cursor-zoom-in rounded hover:ring-2 hover:ring-blue-400 transition"
										...
										<table>
											<tbody>
												...
												<tr>
													...
													<td class="w-2/3"
														>Talon Limited, Offset Direction = Forward/Reverse</td
													>
												</tr>
											</tbody>
										</table>
			...
			<AccordionItem class="text-black dark:text-white" bind:open={openState.ctrepowerdistributionpanel}>
				...
				{#if openState.ctrepowerdistributionpanel === true || loadedState.ctrepowerdistributionpanel === true}
					<div class="flex flex-col pl-1" style="max-width: 375px;">
						<h1 class="px-2 pb-2">
							The two LEDs are always the same color/blink pattern. The only exception is when the device
							is in boot-loader.
						</h1>
						<table cellpadding="5" cellspacing="0" class="text-black dark:text-white">
							<tbody>
						...
						<a
							class="underline text-sm px-2 place-self-end pt-2"
							href="https://ctre.download/files/user-manual/PDP%20User's%20Guide.pdf"
							>Source Link (Page 16)</a
						>
					</div>
				{/if}
			</AccordionItem>
										...
										<table>
											<tbody>
												...
												<tr class="w-100 border-b-2 border-b-gray-600">
													...
													<td>
														No CAN or Solenoid Fault (Will blink # of faulted Solenoid
														followed by pause)
													</td>
												</tr>
												<tr class="w-100 border-b-2 border-b-gray-600">
