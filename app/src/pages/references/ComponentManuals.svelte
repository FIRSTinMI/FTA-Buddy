    ...
    <Accordion flush class="text-left">
        <AccordionItem class="text-black dark:text-white" bind:open={openState.radio}>
            ...
            {#if openState.radio === true || loadedState.radio === true}
                <a href="https://frc-radio.vivid-hosting.net/" target="_blank"><QrCode value="https://frc-radio.vivid-hosting.net/" padding={5} /></a>
            {/if}
        </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.roborio}>
            ...
            {#if openState.roborio === true || loadedState.roborio === true}
                <a href="https://www.ni.com/docs/en-US/bundle/roborio/resource/roborio.pdf?srsltid=AfmBOopSjpf-vTxFsZYLIQrGhHn-m7GKoiZHkRsGJSpym2-IW-Q_xw-x" target="_blank"><QrCode value="https://www.ni.com/docs/en-US/bundle/roborio/resource/roborio.pdf?srsltid=AfmBOopSjpf-vTxFsZYLIQrGhHn-m7GKoiZHkRsGJSpym2-IW-Q_xw-x" padding={5} /></a>
            {/if}
        </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.sparkmax}>
            ...
            {#if openState.sparkmax === true || loadedState.sparkmax === true}
                <a href="https://docs.revrobotics.com/brushless/spark-max/overview/" target="_blank"><QrCode value="https://docs.revrobotics.com/brushless/spark-max/overview" padding={5} /></a>
            {/if}
        </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.sparkflex}>
            ...
            {#if openState.sparkflex === true || loadedState.sparkflex === true}
                <a href="https://docs.revrobotics.com/brushless/spark-flex/overview" target="_blank"><QrCode value="https://docs.revrobotics.com/brushless/spark-flex/overview" padding={5} /></a>
            {/if}    
        </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.talonfx}>
            ...
            {#if openState.talonfx === true || loadedState.talonfx === true}
                <a href="https://v6.docs.ctr-electronics.com/en/stable/docs/hardware-reference/talonfx/" target="_blank"><QrCode value="https://v6.docs.ctr-electronics.com/en/stable/docs/hardware-reference/talonfx/" padding={5} /></a>
            {/if}
        </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.talonsrx}>
            ...
            {#if openState.talonsrx === true  || loadedState.talonsrx === true}
                <a href="https://ctre.download/files/user-manual/Talon%20SRX%20User's%20Guide.pdf" target="_blank"><QrCode value="https://ctre.download/files/user-manual/Talon%20SRX%20User's%20Guide.pdf" padding={5} /></a>
            {/if}
            </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.victorspx}>
            ...
            {#if openState.victorspx === true || loadedState.victorspx === true}
                <a href="https://ctre.download/files/user-manual/Victor%20SPX%20User's%20Guide.pdf" target="_blank"><QrCode value="https://ctre.download/files/user-manual/Victor%20SPX%20User's%20Guide.pdf" padding={5} /></a>
            {/if}
            </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.canivore}>
            ...
            {#if openState.canivore === true || loadedState.canivore === true}
                <a href="https://ctre.download/files/user-manual/CANivore%20User's%20Guide.pdf" target="_blank"><QrCode value="https://ctre.download/files/user-manual/CANivore%20User's%20Guide.pdf" padding={5} /></a>
            {/if}
            </AccordionItem>
        ...
        <AccordionItem class="text-black dark:text-white" bind:open={openState.pigeon}>
            ...
            {#if openState.pigeon === true || loadedState.pigeon === true}
                <a href="https://v6.docs.ctr-electronics.com/en/stable/docs/hardware-reference/pigeon2/" target="_blank"><QrCode value="https://v6.docs.ctr-electronics.com/en/stable/docs/hardware-reference/pigeon2/" padding={5} /></a>
            {/if}
            </AccordionItem>
    </Accordion>
</div>