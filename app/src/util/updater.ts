...
export const LATEST_EXTENSION_VERSION = "1.26.28";
...
export const VERSIONS: { [key: string]: Version } = {
	"2.7.13.10": {
        ...
        <li>Radio kiosk programming screen: amber page, large spinner, team, "Do not unplug" and the status checks</li>
	...
	"2.7.13.9": {
		changelog: `
        <h2 class="font-bold mt-2">Extension v1.26.27</h2>
        <ul>
        <li>Gold confetti on the radio kiosk success screen</li>
        </ul>
        `,
	},
	"2.7.13.8": {
	...
	"2.7.13.2": {
        ...
        <ul>
        <li>Fixed losing your role and admin access on some page loads</li>
        </ul>
        `,
	},
	...
	"2.7.13.0": {
        ...
        <li>Only the selections a ref never made are filled in</li>
	...
	"2.7.9.12": {
        ...
        <ul>
        <li>Scorekeeper view now uses the full laptop width, with larger match/cycle cards and a much larger, more readable match schedule table</li>
        </ul>
        `,
	},
	"2.7.9.11": {
	...
	"2.7.9.6": {
        ...
        <ul>
        <li>Field monitor: the battery match-minimum voltage is now larger and brighter, so it is readable at a glance on desktop instead of blending into the cell</li>
        </ul>
        `,
	},
	"2.7.9.5": {
