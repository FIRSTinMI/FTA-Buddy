...
<Modal bind:open={notesPolicyOpen}>
	...
	{/snippet}
	<p class="text-left">
		All notes and tickets are saved after the end of the event and can be viewed by volunteers at other events this
		team attends in the future.
	</p>
	<p class="text-left">
		Keep this in mind when writing messages, keep it GP and don't include any personal information like names, phone
		numbers, emails.
	</p>
	{#snippet footer()}
		<div class="ml-auto">
