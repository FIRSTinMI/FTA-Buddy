...
{#key currentFlashcard}
    {#if currentFlashcard}
        <div class="overlay flex flex-col justify-center items-center bg-white dark:bg-neutral-900" onclick={dismissFlashcard} onkeydown={dismissFlashcard} role="presentation" id="flashcard-overlay">
